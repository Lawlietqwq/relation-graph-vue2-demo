...
(function(e) {
  ...
  o = function() {
    var d, f, h, g;
    (g = document.createElement("div")).innerHTML = l, l = null, (h = g.getElementsByTagName("svg")[0]) && (h.setAttribute("aria-hidden", "true"), h.style.position = "absolute", h.style.width = 0, h.style.height = 0, h.style.overflow = "hidden", d = h, (f = document.body).firstChild ? (g = d, (h = f.firstChild).parentNode.insertBefore(g, h)) : f.appendChild(d));
  ...
  }, document.addEventListener("DOMContentLoaded", t, !1)) : document.attachEvent && (n = o, i = e.document, s = !1, (a = function() {
    try {
...
const Ee = () => window.innerWidth ? window.innerWidth : document.documentElement.clientWidth ? document.documentElement.clientWidth : screen.width, Ae = () => window.innerHeight ? window.innerHeight : document.documentElement.clientHeight ? document.documentElement.clientHeight : screen.height, Ie = (e) => {
  let o = 0;
  for (const t of e) {
...
const u = (...e) => {
  ...
  getRectPoint(e, o, t, n, i, s, a, l) {
    const r = e + i / 2, c = o + s / 2, d = t + a / 2, f = n + l / 2, h = r < d ? 1 : -1, g = c < f ? 1 : -1;
    if (f === c)
      return { x: r + h * i / 2, y: c };
    const _ = Math.abs((d - r) / (f - c)), w = i / s;
    let C = 0, G = 0;
    return _ < w ? (C = h * s / 2 * _, G = g * s / 2) : (C = h * i / 2, G = g * i / 2 / _), { x: r + C, y: c + G };
  },
  getRectPointBasic(e, o, t, n, i, s, a, l) {
    const r = e + i / 2, c = o + s / 2, d = t + a / 2, f = n + l / 2;
    let h = f === c ? 0 : (d - r) / (f - c);
    h === 0 && (h = (d - r) / (f - c + 1));
    const g = i / l;
    let _ = 0, w = 0, C = "1";
    return -1 * g < h && h < g ? (C = "2", c < f ? (_ = s / 2 * h, w = s / 2) : (_ = -1 * s / 2 * h, w = -1 * s / 2)) : (r < d ? (_ = 1 * i / 2, w = 1 * i / 2 / h) : (_ = -1 * i / 2, w = -1 * i / 2 / h), C = "3"), { x: r + _, y: c + w, _case: C };
  },
  getRectJoinPoint(e, o, t, n, i, s, a, l) {
    const r = e + i / 2, c = o + s / 2, d = t + a / 2, f = n + l / 2, h = Math.round(Math.atan2(f - c, d - r) * 180 / 3.14) + 135;
    return h >= 0 && h < 90 ? { x: e + i / 2, y: o - 5 } : h >= 90 && h < 180 ? { x: e + i + 5, y: o + s / 2 } : h >= 180 && h < 270 ? { x: e + i / 2, y: o + s + 5 } : { x: e - 5, y: o + s / 2 };
  },
  getRectHJoinPoint(e, o, t, n, i, s, a) {
    const l = s / 2;
    return e + i < t ? { x: e + i + 5, y: o + l } : e + i < t + a ? { x: e - 5, y: o + l } : { x: e - 5, y: o + l };
  },
  getRectVJoinPoint(e, o, t, n, i, s, a, l) {
    const r = i / 2;
    return o + s < n ? { y: o + s + 5, x: e + r } : o + s < n + l ? { y: o - 5, x: e + r } : { y: o - 5, x: e + r };
  },
  getBorderPoint(e, o, t, n, i, s, a, l, r) {
    return r === 0 ? this.getCirclePoint(e, o, t, n, i, s, a, l) : this.getRectPoint(e, o, t, n, i, s, a, l);
  },
  getBorderPoint4MultiLine(e, o, t, n, i, s, a, l, r, c, d, f) {
    return r === 0 ? this.getCirclePoint4MultiLine(e, o, t, n, i, s, a, l, c, d, f) : this.getRectPoint(e, o, t, n, i, s, a, l);
  },
  getCirclePoint(e, o, t, n, i, s, a, l) {
    const r = t + a / 2, c = n + l / 2, d = e + i / 2, f = o + s / 2, h = r - d;
    if (h === 0)
      return { x: d, y: f - s / 2 * (c < f ? 1 : -1) };
    const _ = (c - f) / h, w = Math.sqrt(1 / (1 / (i / 2) ** 2 + _ ** 2 / (s / 2) ** 2)) * (r < d ? 1 : -1), C = _ * w;
    return { x: d - w, y: f - C };
  },
  getCirclePoint4MultiLine(e, o, t, n, i, s, a, l, r, c, d) {
    r && (d = c - d - 1);
    const f = t + a / 2, h = n + l / 2, g = e + i / 2, _ = o + s / 2, w = f - g;
    if (w === 0)
      return { x: g, y: _ - s / 2 * (h < _ ? 1 : -1) };
    const C = 40 / (c + 1) * (d + 1) - 20, G = h - _, N = Math.sqrt(w ** 2 + G ** 2) * C / w, M = G / w, y = i / 2, L = s / 2, m = f < g ? 1 : -1, k = (-1 * y ** 2 * M * N + y * L * Math.sqrt(L ** 2 + M ** 2 * y ** 2 - N ** 2, 2) / m) / (L ** 2 + y ** 2 * M ** 2), W = M * k + N;
    return { x: g - k, y: _ - W };
  },
  getCirclePointBasic(e, o, t, n, i, s, a, l, r) {
    const c = e + i / 2, d = o + s / 2, f = t + a / 2, h = n + l / 2;
    return this.h = f - c, this.s = h - d, this.c = Math.sqrt(this.h * this.h + this.s * this.s), this.l = this.c - r, this.v = this.l * this.h / this.c * -1, this.t = this.l * this.s / this.c * -1, { x: f + this.v, y: h + this.t };
  },
  getCirclePointPlus(e, o, t, n, i, s, a, l) {
    const r = e + i / 2, c = o + s / 2, d = t + a / 2, f = n + l / 2;
    return this.h = d - r, this.s = f - c, this.c = Math.sqrt(this.h * this.h + this.s * this.s), this.v = (this.c - i / 2) * this.h / this.c * -1, this.t = (this.c - s / 2) * this.s / this.c * -1, { x: d + this.v, y: f + this.t };
  },
  getOvalPoint(e, o, t, n, i) {
    return {
      x: e + t * Math.sin((ie + n * (360 / i) + 0) * Math.PI / 180),
      y: o + t * Math.cos((ie + n * (360 / i) + 0) * Math.PI / 180) * -1
    };
  },
  getAngleType(e, o) {
    if (e >= 0 && o >= 0)
  ...
  analysisNodes(e, o, t, n, i) {
    ...
    o.forEach((r) => {
      ...
      if (r.targetNodes) {
        ...
        r.targetNodes.forEach((f) => {
          f.lot || (f.lot = { eached: !1 }), f.lot.eached || (x.isAllowShowNode(f) ? (f.lot.eached = !0, f.lot.parent = r, f.lot.index_of_parent = d++, r.lot.childs.push(f), a.push(f), c++) : r.lot.childs.push(f));
        });
      }
    ...
    }), s.all_strength > n.max_strength && (n.max_strength = s.all_strength), a.length > 0 ? this.analysisNodes(e, a, t + 1, n, i) : (e.forEach((r) => {
  ...
  analysisNodes4Didirectional(e, o, t, n, i) {
    ...
    o.forEach((r) => {
      ...
      r.lot.strength = c > 0 ? c : 1, s.all_strength += r.lot.strength, r.lot.strength_plus = s.all_strength, r.lot.index_of_level = l, r.lot.childs_size = c, l++;
    }), s.all_strength > n.max_strength && (n.max_strength = s.all_strength), a.length > 0 ? x.analysisNodes4Didirectional(e, a, t + (i === -1 ? -1 : 1), n, i) : (e.forEach((r) => {
      r.lot.childs_size > 0 && (r.lot.strengthWithChilds = 0);
    }), e.forEach((r) => {
  ...
  const i = e - t, s = o - n, a = i ** 2, l = s ** 2, r = a + l;
  return Math.sqrt(r);
}, Y = (e) => {
  if (e.from === void 0)
...
}, Oe = ["arrow", "id", "reverseText", "isReverse"], X = (e, o) => {
  !e || e.relations.forEach((t) => {
    const n = {};
    Object.keys(t).forEach((i) => {
      Oe.includes(i) || t[i] !== void 0 && (n[i] = t[i]);
    }), o.push(n);
  });
}, F = {
  border: "border",
...
class q {
  constructor(o) {
    const t = ye(o);
    u("RGOptions:new RGOptions:by:", o), u("RGOptions:new RGOptions:by:", this), Object.assign(this, t), this.instanceId = `RGIns-${We++}`;
  }
}
const De = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createDefaultConfig: ye,
  appendDefaultOptions4Layout: xe,
  default: q
  ...
  return Object.keys(e).forEach((t) => {
    Ve.includes(t) || e[t] !== void 0 && (o[t] = e[t]);
  }), o;
}, Te = {
  json2Node: K,
  transNodeToJson: Q
...
class ve {
    ...
    t.forEach((c) => {
      ...
      if (s === -1) {
        ...
        c.targetFrom.forEach((h) => {
          h.lot || (h.lot = { eached: !1 }), h.lot.eached || (x.isAllowShowNode(h) ? (h.lot.eached = !0, h.lot.parent = c, h.lot.index_of_parent = f++, c.lot.childs.push(h), l.push(h), d++) : c.lot.childs.push(h));
        });
      } else {
        let f = 0;
      ...
      c.lot.strength = d > 0 ? d : 1, a.all_strength += c.lot.strength, c.lot.strength_plus = a.all_strength, c.lot.index_of_level = r, c.lot.childs_size = d, r++;
    }), a.all_strength > i.max_strength && (i.max_strength = a.all_strength), l.length > 0 ? this.analysisNodes4Didirectional(o, l, n + s, i, s) : (o.forEach((c) => {
  ...
  placeNodesPosition(o, t, n) {
    ...
    this.placeRelativePosition(o, n, r), t.forEach((c) => {
      ...
      if (!x.isAllowShowNode(c))
        return;
      const d = c.offset_x || 0, f = c.offset_y || 0;
  ...
  placeRelativePosition(o, t, n) {
    if (this.config.from === "left" || this.config.from === "right") {
      const i = this.config.min_per_height || 80, s = this.config.max_per_height || 400, a = this.config.min_per_width || 430, l = this.config.max_per_width || 650;
      ...
      c < i && (c = i), c > s && (c = s), this.allNodes.forEach((d) => {
        d.fixed !== !0 && d.lot.placed !== !0 && d !== o && (this.config.from === "right" ? d.lot.x = o.lot.x - this.getLevelDistance(d, d.lot.subling.level, r) : d.lot.x = o.lot.x + this.getLevelDistance(d, d.lot.subling.level, r));
      }), this.allNodes.forEach((d) => {
        d.fixed !== !0 && d.lot.level !== 0 && (d.lot.y = o.lot.y + c * (t.max_strength / -2 + d.lot.strengthWithChilds_from + d.lot.strengthWithChilds / 2));
      });
    } else {
      const i = this.config.min_per_height || 250, s = this.config.max_per_height || 400, a = this.config.min_per_width || 250, l = this.config.max_per_width || 500;
      let r = Math.round((n.__mapWidth - 10) / (t.max_strength + 2));
      r < a && (r = a), r > l && (r = l);
      let c = Math.round((n.__mapHeight - 10) / (t.max_deep + 2));
      c < i && (c = i), c > s && (c = s), this.allNodes.forEach((d) => {
        d.fixed !== !0 && d.lot.placed !== !0 && d !== o && (this.config.from === "bottom" ? d.lot.y = o.lot.y - this.getLevelDistance(d, d.lot.subling.level, c) : d.lot.y = o.lot.y + this.getLevelDistance(d, d.lot.subling.level, c));
      }), this.allNodes.forEach((d) => {
        d.fixed !== !0 && d.lot.level !== 0 && (d.lot.x = o.lot.x + r * (t.max_strength / -2 + d.lot.strengthWithChilds_from + d.lot.strengthWithChilds / 2));
      });
    }
  }
...
class we {
  ...
  placeNodes(o, t) {
    ...
    x.analysisNodes4Didirectional(this.allNodes, [this.rootNode], 0, n, 0), t.lot.x = -(t.el.offsetWidth || t.width) / 2, t.lot.y = -(t.el.offsetHeight || t.height) / 2, u("root position:", t.lot.x, t.lot.y), this.placeRelativePosition(this.rootNode, n), this.allNodes.forEach((i) => {
      if (i.fixed === !0 || !x.isAllowShowNode(i))
        return;
      const s = i.offset_x || 0, a = i.offset_y || 0;
  ...
  placeRelativePosition(o, t) {
    ...
    this.allNodes.forEach((l) => {
      if (l.lot.subling.level === 1) {
        ...
        const r = x.getOvalPoint(o.lot.x, o.lot.y, l.lot.subling.level * s, l.lot.strength_plus - l.lot.strength / 2, l.lot.subling.all_strength);
    ...
    this.allNodes.forEach((l) => {
      if (l.lot.subling.level > 1) {
        const r = l.lot.parent.lot.strength_plus - l.lot.parent.lot.strength, d = (l.lot.parent.lot.strength_plus - r) / (l.lot.parent.lot.childs_size + 1) * (l.lot.index_of_parent + 1), f = x.getOvalPoint(o.lot.x, o.lot.y, (l.lot.subling.level - 1) * a + s, r + d, l.lot.parent.lot.subling.all_strength);
  ...
  addElasticByLine(o, t) {
    ...
    n > 1e3 && (n = 1e3);
    const i = n < 30 ? 0 : (n - 30) * 0.05, s = i, a = i, l = (o.x - t.x) / n, r = (o.y - t.y) / n;
...
class be {
  ...
  checkMaxDeepAndLength(o, t) {
    ...
    o.forEach((l) => {
      ...
      l.targetNodes && (l.targetNodes.forEach((c) => {
        u("child node::", c.type, c.lot.eached), c.lot || (c.lot = { eached: !1 }), c.type === "node" && c.targetNodes.length <= 1 ? c.lot.eached || (c.lot.parent = l, c.lot.index_of_p_childs = r, c.lot.prevNode = a, a && (a.lot.nextNode = c), a = c, l.lot.childs.push(c), l.lot.eached = !0, i.push(c), r++) : c.lot.notLeafNode = !0;
      }), l.targetNodes.forEach((c) => {
        c.lot.notLeafNode && (c.lot || (c.lot = { eached: !1 }), c.lot.eached || (c.lot.parent = l, c.lot.index_of_p_childs = r, c.lot.prevNode = a, a && (a.lot.nextNode = c), a = c, l.lot.childs.push(c), l.lot.eached = !0, i.push(c), r++));
      })), l.lot.strength = r > 0 ? r : 1, n.all_strength += l.lot.strength, l.lot.strength_plus = n.all_strength, l.lot.level_index = s, l.lot.childs_size = r, s++;
  ...
  placeNodes(o, t) {
    ...
    this.__origin_nodes = o, this.rootNode = t, o.forEach((a) => {
      a.lot.eached = !1, a.lot.notLeafNode = !1, a.lot.childs = [], a.lot.parent = void 0, a.lot.index_of_p_childs = 0, a.lot.strength = 0, a.lot.prevNode = void 0, a.lot.nextNode = void 0;
    }), this.allNodes = o, u("max before:", this.__max_deep, this.__max_length), u("max after:", this.__max_deep, this.__max_length);
    const n = {
      x: 0,
      y: 0
  ...
  addGravityByNode(o, t) {
    ...
    let s = o.x - t.x, a = o.y - t.y;
    s === 0 && (s = 1), a === 0 && (a = 1), this.addFtoNode(o, s * i, a * i), this.addFtoNode(t, s * -1 * i, a * -1 * i);
  }
  addFtoNode(o, t, n) {
    o.Fx += t, o.Fy += n;
  }
...
class ee {
  ...
  initNodesPosition() {
    this.rootNode.lot.x = -(this.rootNode.el.offsetWidth || this.rootNode.width) / 2, this.rootNode.lot.y = -(this.rootNode.el.offsetHeight || this.rootNode.height) / 2, u("root position:", this.rootNode.lot.x, this.rootNode.lot.y), u("[layout canvasOffset]", this.graphOptions.viewSize, this.graphOptions.canvasSize), this.placeRelativePosition(this.rootNode), this.__origin_nodes.forEach((o) => {
  ...
  placeRelativePosition(o) {
    ...
    this.allNodes.forEach((n) => {
      ...
      if (n.lot.subling.level > 1) {
        const i = n.lot.parent.lot.strength_plus - n.lot.parent.lot.strength, a = (n.lot.parent.lot.strength_plus - i) / (n.lot.parent.lot.childs_size + 1) * (n.lot.index_of_parent + 1), l = x.getOvalPoint(o.lot.x, o.lot.y, (n.lot.subling.level - 1) * 80 + t, i + a, n.lot.parent.lot.subling.all_strength);
...
const ke = (e, o) => {
  ...
  let t = null;
  return e.layoutName === "SeeksBidirectionalTreeLayouter" || e.layoutName === "tree" ? t = new ve(e, o) : e.layoutName === "SeeksCenterLayouter" || e.layoutName === "center" ? t = new we(e, o) : e.layoutName === "SeeksCircleLayouter" || e.layoutName === "circle" ? t = new be(e, o) : e.layoutName === "SeeksForceLayouter" || e.layoutName === "force" ? t = new ee(e, o) : (e.layoutName === "SeeksFixedLayouter" || e.layoutName === "fixed") && (t = new Ce(e, o)), o.isNeedShowAutoLayoutButton = e.allowAutoLayoutIfSupport !== !1 && t.autoLayout !== void 0, t;
}, Ze = (e, o) => {
  ...
  u("[change layout]switchLayout"), o.layouter = ke(e, o), o.layouter.__origin_nodes = t, o.layouter.rootNode = n;
};
class Je {
  constructor(o, t) {
    p(this, "instanceId", "");
    p(this, "options");
    p(this, "listeners");
    this.listeners = t, this.options = new q(o), this.instanceId = this.options.instanceId, u("new RelationGraph:", this);
  }
  enableDebugLog(o) {
...
const se = (e) => {
  ...
  startDrag(e, o, t, n) {
    n ? Z = (i, s, a) => {
      const l = i - O.x, r = s - O.y;
      n(l, r, B, O, a);
    } : Z = (i, s) => {
      R.x = B.x + (i - O.x), R.y = B.y + (s - O.y);
    }, J = t, R = o, B.x = R.x, B.y = R.y, u("[canvas]onDragStart...", H, e);
    try {
      const i = se(e);
      O.x = i.clientX, O.y = i.clientY, H ? (e.preventDefault(), document.body.addEventListener("touchmove", $.onNodeMove), document.body.addEventListener("touchend", $.onNodeDragend)) : (document.body.addEventListener("mousemove", $.onNodeMove), document.body.addEventListener("mouseup", $.onNodeDragend));
    } catch (i) {
  ...
  onNodeMove(e) {
    const o = se(e);
    Z(o.clientX, o.clientY, e);
  },
  onNodeDragend(e) {
    H ? (document.body.removeEventListener("touchmove", $.onNodeMove), document.body.removeEventListener("touchend", $.onNodeDragend)) : (document.body.removeEventListener("mousemove", $.onNodeMove), document.body.removeEventListener("mouseup", $.onNodeDragend)), u("Node dragend"), J && J(
      R.x - B.x,
      R.y - B.y,
      e
    );
  ...
  transName4Circle(e) {
    ...
    const n = [];
    for (const i of e)
      t.push(i), t.length === Ue[o] && (n.push(t.join("")), o++, t = []);
...
class Ye extends Je {
  ...
  setOptions(t, n) {
    this.options = new q(t), this.initLayouter(), this.resetViewSize(), this.doLayout(), this.resetViewSize(), n && n(this);
  }
  setLayouter(t) {
  ...
  initLayouter() {
    if (this.userLayouerClass)
      ...
      u("[change layout]Create default layouter\uFF1A", this.options.layoutName), t.layouter ? this.options.layouter = t.layouter : this.options.layouter = ke(t, this.options);
    } else
  ...
  loadLines(t) {
    t.forEach((n) => {
      let i = !1, s, a;
      if (typeof n.from == "object" ? s = n.from : s = this.tmpData.nodes_map[n.from], typeof n.to == "object" ? a = n.to : a = this.tmpData.nodes_map[n.to], !s) {
      ...
      const l = `${s.seeks_id}-${a.seeks_id}`, r = `${a.seeks_id}-${s.seeks_id}`, c = Y(n);
      let d, f = !1;
      this.tmpData.lines_map[l] ? d = this.tmpData.lines_map[l] : this.tmpData.lines_map[r] ? (d = this.tmpData.lines_map[r], f = !0) : (i = !0, d = {
        seeks_id: l,
        fromNode: s,
        toNode: a,
        appended: !1,
      ...
      let h = c.arrow;
      c.isHideArrow || (h = this.getLineArrow(c.color)), s.targetNodes || (s.targetNodes = []), a.targetNodes || (a.targetNodes = []), s.targetNodes.includes(a) || s.targetNodes.push(a), a.targetNodes.includes(s) || a.targetNodes.push(s), s.targetTo.includes(a) || s.targetTo.push(a), a.targetFrom.includes(s) || a.targetFrom.push(s);
      let g = !1;
      ...
      g === !1 && (c.id || (c.id = `${d.seeks_id}-${d.relations.length}`), c.isReverse = f, c.arrow = h, c.textPositon = { x: 0, y: 0 }, d.relations.push(c)), i && (this.graphData.links.push(d), this.tmpData.lines_map[l] = d, d.appended = !1);
    });
  }
  ...
  removeNodeById(t) {
    ...
    for (let s = 0; s < this.graphData.links.length; s++) {
      ...
      (a.fromNode.id === t || a.toNode.id === t) && (a.hidden = !0, this.graphData.links.splice(s, 1), s--, n++);
    }
    u("\u5220\u9664\u5BF9\u5E94\u7684\u7EBF\u4E2A\u6570\uFF1A", t, n);
    let i = 0;
  ...
  handleSelect(t) {
    u("checked:", t), scrollTo({
      ...
      const n = t.width || 50, i = t.height || 50, s = t.x * -1 + this.options.viewSize.width / 2 - n / 2, a = t.y * -1 + this.options.viewSize.height / 2 - i / 2;
...
class qe extends Xe {
  ...
  showZoomCenter(t, n) {
    ...
    const a = s / i, l = 0, r = 0, c = s / i, d = 0, f = 0;
    this.zoomCenter_of_newSize.x = a * this.currentZoomSet.NMViewBuff.x + r * this.currentZoomSet.NMViewBuff.y + d, this.zoomCenter_of_newSize.y = l * this.currentZoomSet.NMViewBuff.x + c * this.currentZoomSet.NMViewBuff.y + f;
    const h = this.currentZoomSet.NMViewBuff.x - this.zoomCenter_of_newSize.x, g = this.currentZoomSet.NMViewBuff.y - this.zoomCenter_of_newSize.y;
    ...
    let _ = this.currentZoomSet.NMCanvasStart.x - this.currentZoomSet.NMCanvasCenter.x, w = this.currentZoomSet.NMCanvasStart.y - this.currentZoomSet.NMCanvasCenter.y, C = a * _ + r * w + d, G = l * _ + c * w + f;
    return this.newZoomSet.NMCanvasStart.x = h + this.currentZoomSet.NMCanvasCenter.x + C, this.newZoomSet.NMCanvasStart.y = h + this.currentZoomSet.NMCanvasCenter.y + G, _ = this.currentZoomSet.NMCanvasEnd.x - this.currentZoomSet.NMCanvasCenter.x, w = this.currentZoomSet.NMCanvasEnd.y - this.currentZoomSet.NMCanvasCenter.y, C = a * _ + r * w + d, G = l * _ + c * w + f, this.newZoomSet.NMCanvasEnd.x = h + this.currentZoomSet.NMCanvasCenter.x + C, this.newZoomSet.NMCanvasEnd.y = h + this.currentZoomSet.NMCanvasCenter.y + G, this.currentZoomSet.NMCanvasOffsetBuff.x = h, this.currentZoomSet.NMCanvasOffsetBuff.y = g, {
      buff_x: h,
      buff_y: g
    };
  }
  analysisByZoom(t, n) {
    ...
    }, s = Ee(), a = Ae(), l = this.$dom.getBoundingClientRect();
    i.NMViewPosition.x = l.left, i.NMViewPosition.y = l.top, l.width + i.NMViewPosition.x > s ? i.NMViewCenter.x = (s - l.left) / 2 : i.NMViewCenter.x = l.width / 2, l.height + i.NMViewPosition.y > a ? i.NMViewCenter.y = (a - l.top) / 2 : i.NMViewCenter.y = l.height / 2;
    const r = this.options.canvasSize.width * t, c = this.options.canvasSize.height * t;
    i.NMCanvasCenter.x = this.options.canvasOffset.x + this.options.canvasSize.width / 2, i.NMCanvasCenter.y = this.options.canvasOffset.y + this.options.canvasSize.height / 2, i.NMCanvasStart.x = i.NMCanvasCenter.x - r / 2, i.NMCanvasStart.y = i.NMCanvasCenter.y - c / 2, i.NMCanvasEnd.x = i.NMCanvasCenter.x + r / 2, i.NMCanvasEnd.y = i.NMCanvasCenter.y + c / 2, i.NMZoomCenter.x = i.NMViewCenter.x, i.NMZoomCenter.y = i.NMViewCenter.y, n && (i.NMZoomCenter.x = n.x - i.NMViewPosition.x, i.NMZoomCenter.y = n.y - i.NMViewPosition.y);
    let d = i.NMViewCenter.x - i.NMCanvasCenter.x, f = i.NMViewCenter.y - i.NMCanvasCenter.y;
    return n && (d = i.NMZoomCenter.x - i.NMCanvasCenter.x, f = i.NMZoomCenter.y - i.NMCanvasCenter.y), i.NMViewBuff.x = d, i.NMViewBuff.y = f, i.NMCanvasSize.width = r, i.NMCanvasSize.height = c, i;
  }
}
class Ke extends qe {
  constructor(o, t) {
  ...
  getStuffSize() {
    ...
    this.graphData.nodes.forEach((r) => {
      r.x < o && (o = r.x), r.x > n && (n = r.x + r.el.offsetWidth), r.y < t && (t = r.y), r.y > i && (i = r.y + r.el.offsetHeight);
    });
    const s = 100, a = n - o + s, l = i - t + s;
    return {
      width: a,
      height: l,
      minX: o,
  ...
  placeSingleNode() {
    ...
    if (this.graphData.nodes.forEach((n) => {
      o.includes(n) || n.targetNodes && n.targetNodes.length === 0 && n.fixed !== !0 && (n.x = Math.floor(Math.random() * 200) - 100, n.y = Math.floor(Math.random() * 200) - 100, n.lot || (n.lot = { childs: [] }), n.lot.placed = !0, t.push(n));
    }), t.length > 0) {
  ...
  animateGoto(o, t, n, i) {
    u("animateGoto:", o, t);
    const s = o - this.options.canvasOffset.x, a = t - this.options.canvasOffset.y, l = n, r = 5, c = Math.round(s / r), d = Math.round(a / r), f = l / r;
  ...
  animateToZoom(o, t, n) {
    const i = o - this.options.canvasZoom, s = t, a = 5, l = Math.round(i / a), r = s / a;
...
class et extends Qe {
  ...
  downloadAsImage(o, t) {
    ...
    const i = this.$canvasDom, s = i.clientWidth, a = i.clientHeight;
    let l = 999999, r = 999999, c = 0, d = 0;
    const f = 100;
    this.graphData.nodes.forEach((m) => {
      m.x < l && (l = m.x), m.x > c && (c = m.x + m.el.offsetWidth), m.y < r && (r = m.y), m.y > d && (d = m.y + m.el.offsetHeight);
    });
    const h = l - f, g = r - f;
    this.graphData.nodes.forEach((m) => {
      m.x = m.x - h, m.y = m.y - g;
    ...
    this.options.canvasOffset.x = f * -1, this.options.canvasOffset.y = f * -1, u("offset:", { _origin_offset_x: _, _origin_offset_y: w, _min_x: l, _min_y: r, _max_x: c, _max_y: d });
    const C = c - l + 200 + f * 2, G = d - r + 100 + f * 2, N = window.devicePixelRatio;
    this.options.canvasSize.width = C * N, this.options.canvasSize.height = G * N;
    const M = {
    ...
    window.scrollTo(0, 0), u("export image:", { relationGraphPosition: M, orign_width: s, orign_height: a, _image_width: C, _image_height: G, _min_x: l, _min_y: r, _max_x: c, _max_y: d, devicePixelRatio: window.devicePixelRatio });
    const y = document.createElement("canvas");
    y.width = C * N, y.height = G * N, y.style.backgroundColor = getComputedStyle(i.parentElement, null).backgroundColor, u("canvas.style.backgroundColor:", y.style.backgroundColor), y.style.width = `${C * N}px`, y.style.height = `${G * N}px`, y.getContext("2d").scale(1, 1);
    const L = {
    ...
    setTimeout(() => {
      this.createImage(i, L, o, t, (m) => {
        u("downloadImageAsFile:", L, o, t), this.listeners.onImageSaveAsFile ? this.listeners.onImageSaveAsFile(
          m,
          o,
          t
        ) : this.downloadImageAsFile(m, o, t), this.options.canvasSize.width = s, this.options.canvasSize.height = a, this.options.canvasOffset.x = _, this.options.canvasOffset.y = w, this.options.canvasZoom = n, this.graphData.nodes.forEach((k) => {
          k.x = k.x + h, k.y = k.y + g;
        });
      });
    }, 1e3);
  ...
  downloadImageAsFile(o, t, n) {
    ...
    try {
      window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveOrOpenBlob(s, `${n}.${t}`) : (a.setAttribute("href", URL.createObjectURL(s)), a.setAttribute("download", `${n}.${t}`), document.body.appendChild(a), a.click(), u("click ok!"), URL.revokeObjectURL(s), u("revokeObjectURL ok!"), document.body.removeChild(a), u("removeChild ok!"));
    } catch (l) {
...
class tt extends et {
  ...
  createLinePath(o, t, n) {
    ...
    let r = i.x, c = i.y, d = s.x, f = s.y;
    const h = { x: 0, y: 0, rotate: 0 };
    if (Number.isNaN(r) || Number.isNaN(c))
      return u("error start node:", i), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 100 100", h);
    if (Number.isNaN(d) || Number.isNaN(f))
      return u("error start point:", i), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 100 100", h);
    ...
    let M, y, L = this.options.defaultJunctionPoint;
    if (L || (L = F.border), L === F.border ? (M = x.getBorderPoint4MultiLine(...G), y = x.getBorderPoint4MultiLine(...N)) : L === F.ltrb ? (M = x.getRectJoinPoint(...G), y = x.getRectJoinPoint(...N)) : L === F.tb ? (M = x.getRectVJoinPoint(...G), y = x.getRectVJoinPoint(...N)) : L === F.lr && (M = x.getRectHJoinPoint(...G), y = x.getRectHJoinPoint(...N)), !M || !y)
      return this.createReturnValue(
        "Can not create start and end!",
        h
      );
    const m = M.x, k = M.y, W = y.x, T = y.y;
    if (Number.isNaN(m) || Number.isNaN(k))
      return console.error("error start point:", i), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 100 100", h);
    if (Number.isNaN(W) || Number.isNaN(T))
      return console.error("error end point:", s), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 100 100", h);
    let b = y.x - M.x, v = y.y - M.y, S = y.x > M.x ? 1 : -1;
    l === "v" && (S = y.y > M.y ? 1 : -1);
    let z = "";
    if (a === 4) {
      const P = 60 / (o.relations.length + 1) * (n + 1) - 30;
      l === "v" ? (v = v - (S * 33 + P), h.x = m + b + 5, h.y = k + S * 40 + P, h.rotate = 90, z = `M ${m} ${k} v${S * 33 + P} h${b + P} v${v}`) : t.reverseText === !0 ? (h.x = m + S * 10 - (S < 0 ? 30 : 0), h.y = k - 5, b = b - S * 120, z = `M ${m} ${k} h${S * 120} v${v} h${b}`) : (h.x = m + S * 50 - (S < 0 ? 30 : 0), h.y = k + v - 5 + P, b = b - (S * 33 + P), v = v + S * P, z = `M ${m} ${k} h${S * 33 + P} v${v} h${b}`);
    } else if (a === 2) {
      const P = y.y > M.y ? 1 : -1, A = Math.abs(b) + Math.abs(v);
      h.x = Math.round(y.x - b / A * 60 - 20), h.y = Math.round(
        y.y - v / A * 60 - 20 * P
      );
      const V = 1 / (o.relations.length + 1) * (n + 1) - 0.5 + 0.5;
      l === "v" ? z = `M${m},${k} c${0},${S * 30} ${b * V},${S * -10} ${b},${v}` : z = `M${m},${k} c${S * 30},${0} ${S * -10},${v * V} ${b},${v}`;
    } else if (a === 6) {
      const P = y.y > M.y ? 1 : -1, A = Math.abs(b) + Math.abs(v);
      h.x = Math.round(y.x - b / A * 60 - 20), h.y = Math.round(
        y.y - v / A * 60 - 20 * P
      ), l === "v" ? z = `M${m},${k} c${0},${v / 2} ${b},${v / 2} ${b},${v}` : z = `M${m},${k} c${b / 2},${0} ${b / 2},${v} ${b},${v}`;
    } else if (a === 3) {
      h.x = y.x - S * 63, h.y = y.y + 3;
      const P = 1 / (o.relations.length + 1) * (n + 1) - 0.5 + 0.5;
      l === "v" ? z = `M${m},${k} c${0},${v * P} ${0},${0} ${b},${v}` : z = `M${m},${k} c${S * 30},${0} ${S * -10},${v * P} ${b},${v}`;
    } else if (a === 5) {
      h.x = y.x - S * 63, h.y = y.y + 3;
      const P = 1 / (o.relations.length + 1) * (n + 1) - 0.5 + 0.5;
      l === "v" ? z = `M${m},${k} c${0},${0} ${0},${v * P} ${b},${v}` : z = `M${m},${k} c${0},${0} ${b * P},${0} ${b},${v}`;
    } else {
      const P = x.getAngleType(b, v);
      h.rotate = x.getTextAngle(m, k, W, T);
      const A = P === 2 || P === 4 ? -1 : 1, V = (v === 0 ? -50 : Math.sin(Math.atan(b / v)) * 10 / Math.sin(90)) * A, Se = b === 0 ? -50 : Math.sin(Math.atan(v / b)) * 10 / Math.sin(90);
      h.x = Math.round(M.x + b / 2 - V), h.y = Math.round(M.y + v / 2 - Se), Number.isNaN(h.rotate) && (h.rotate = 0), z = `M ${m} ${k} L ${W} ${T}`;
    }
    return this.createReturnValue(z, h);
  }
...
function E(e, o, t, n, i, s, a, l) {
  var r = typeof e == "function" ? e.options : e;
  o && (r.render = o, r.staticRenderFns = t, r._compiled = !0), n && (r.functional = !0), s && (r._scopeId = "data-v-" + s);
  var c;
  if (a ? (c = function(h) {
    h = h || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext, !h && typeof __VUE_SSR_CONTEXT__ != "undefined" && (h = __VUE_SSR_CONTEXT__), i && i.call(this, h), h && h._registeredComponents && h._registeredComponents.add(a);
...
var lt = function() {
  var e = this, o = e.$createElement, t = e._self._c || o;
  return t("g", [t("path", { class: ["c-rg-line", e.relation.styleClass, e.checked ? "c-rg-line-checked" : ""], style: {
...
var pt = function() {
  ...
  return t("g", [t("use", { class: ["c-rg-line", e.checked ? "c-rg-line-checked" : ""], attrs: { "xlink:href": "#" + e.relationGraph.options.instanceId + "-" + e.link.seeks_id + "-" + e.relationIndex }, on: { click: function(n) {
    return e.onClick(e.relation, n);
  } } }), t("text", { staticClass: "c-rg-line-text", style: {
    opacity: e.relation.opacity,
    fill: e.checked ? e.relationGraph.options.checkedLineColor : e.relation.fontColor ? e.relation.fontColor : e.relation.color ? e.relation.color : void 0
  }, attrs: { x: e.textOffset, y: "0" }, on: { click: function(n) {
    return e.onClick(e.relation, n);
...
const mt = {
  ...
  computed: {
    ...
    textOffset() {
      const e = Ie(this.relation.text) * 10;
      return (Be(this.link.fromNode.x, this.link.fromNode.y, this.link.toNode.x, this.link.toNode.y) - e) / 2;
    }
  },
  data() {
    return {
...
const bt = {
  name: "SeeksRGLink",
  components: { RGLineSmart: ut, RGLineTextByPath: xt },
  props: {
    relationGraph: {
      mustUseProp: !0,
      default: () => ({}),
...
const At = {
  ...
  components: { SeeksRGNode: rt, SeeksRGLink: Gt, SeeksRGLinePath: zt },
  props: {
    relationGraph: {
      mustUseProp: !1,
      default: () => ({}),
  ...
  methods: {
    ...
    onDragStart(e) {
      ...
      if (H) {
        let t = null, n = null;
        o = (i, s, a, l, r) => {
          const c = r.touches || r.targetTouches, d = c[0];
          if (c && c.length > 1) {
            r.preventDefault();
            const f = c[1];
            t || (t = { x: f.clientX, y: f.clientY }, n = this.relationGraph.options.canvasZoom);
            const h = { x: d.clientX, y: d.clientY }, g = { x: f.clientX, y: f.clientY }, _ = Math.hypot(t.x - l.x, t.y - l.y), C = Math.hypot(g.x - h.x, g.y - h.y) / _, G = n * C;
            this.relationGraph.setZoom(G);
          } else {
            const f = d.clientX, h = d.clientY, g = a.x + (f - l.x), _ = a.y + (h - l.y);
...
const Kt = {
  ...
  methods: {
    ...
    switchLayout(e) {
      u("change layout:", e), Ze(e, this.relationGraph.options), this.refresh();
    },
    toggleAutoLayout() {
...
const io = {
  ...
  components: { GraphMiniToolBar: to, GraphMiniView: Yt, RGCanvas: Bt, GraphDebugPanel: Vt },
  props: {
    options: {
      mustUseProp: !1,
      default: () => ({}),
  ...
  created() {
    window && (window.relationGraphDebug = this.options.debug), u("---------------------------graph created---------------------------", this), console.log(
      `%c relation-graph %c Version v${ge} %c More info: https://github.com/seeksdream/relation-graph %c`,
    ...
    let e = !1;
    if (!I || !I.version || I.version.startsWith("3")) {
    ...
    I.version.slice(0, 4) === "2.5." && (e = !0), I.version.slice(0, 4) === "2.6." && Number.parseInt(I.version.split(".")[2]) <= 12 && (e = !0), e && console.error(`\u60A8\u7684Vue\u7248\u672C\uFF1A${I.version}\u6CE8\u610F\uFF1A\u5F53\u4F60\u4F7F\u7528\u7684vue\u7248\u672C\u7B49\u4E8E\u4F4E\u4E8E2.6.12\u65F6\uFF0C\u56FE\u8C31\u4F1A\u663E\u793A\u4E0D\u6B63\u5E38\uFF0C\u53C2\u8003\u8FD9\u4E2A\u8FDE\u63A5\u89E3\u51B3\u8FD9\u4E2A\u95EE\u9898\uFF1Ahttps://github.com/seeksdream/relation-graph/issues/113`), D || console.error("[relation-graph]Please introduce component screenfull, for example:https://cdnjs.cloudflare.com/ajax/libs/screenfull.js/5.1.0/screenfull.min.js"), me || console.error("[relation-graph]Please introduce component html2canvas, for example:https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js");
  },
  mounted() {
    u("---------------------------graph mounted---------------------------");
    const e = {
    ...
    }, o = this.relationGraphCore || new Ge(this.options, e);
...
const U = /* @__PURE__ */ function() {
  ...
  BidirectionalTreeLayouter: ve,
  CenterLayouter: we,
  CircleLayouter: be,
  FixedLayouter: Ce,
  ForceLayouter: ee
}, co = De, ho = He, fo = je, Me = (e, o) => {
  e.component("RelationGraph", U), e.component("SeeksRelationGraph", U);
};
typeof window != "undefined" && window.Vue && Me(window.Vue);
const go = ne(oe({}, U), {
  RelationGraphCore: ro,
  Layout: lo,
  RGOptions: co,
  RGLink: ho,
  RGNode: fo,
